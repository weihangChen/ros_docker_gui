...
So, the new developer or master students can easily start working on the algorithm instead of troubling with install and configure Ubuntu. The ros version is melodic, gazebo version is 9. This blog post is about docker and GUI signal forwarding from docker container (ubuntu) to windows. I make a [video](https://youtu.be/W3sR1qt0CAM) demonstrating a few user cases.
